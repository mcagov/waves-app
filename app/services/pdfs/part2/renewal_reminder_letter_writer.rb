class Pdfs::Part2::RenewalReminderLetterWriter <
  ...
  def draw_bg(p)
    ...
    @pdf.image "#{dir}part_2_registration_renewal_letter-#{p}.png",
               scale: 0.35, at: [-26, 810]
  end

  def details_box
    @pdf.draw_text @vessel[:name], at: [170, 536]
    @pdf.draw_text @vessel[:reg_no], at: [170, 510]
  end
end
