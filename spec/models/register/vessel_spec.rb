...
describe Register::Vessel, type: :model do
  describe "validations" do
    context "when the vessel is valid" do
      ...
      describe "hull ID number" do
        it "is blank" do
          vessel = build(:register_vessel, hin: "")
          vessel.valid?
      ...
      describe "number of hulls" do
        ...
        it "is greater than 0" do
          vessel = build(:register_vessel, number_of_hulls: 1)
          vessel.valid?
        ...
        it "is less than 6" do
          vessel = build(:register_vessel, number_of_hulls: 5)
          vessel.valid?
        ...
        it "is exactly 6" do
          vessel = build(:register_vessel, number_of_hulls: 6)
          vessel.valid?
      ...
      describe "radio call sign" do
        ...
        it "is 6 characters long" do
          ...
          vessel = build(:register_vessel, radio_call_sign: radio_call_sign)
          vessel.valid?
    ...
    context "when the vessel is invalid" do
      describe "vessel name" do
        it "is not present" do
          vessel = build(:register_vessel, name: " ")
      ...
      describe "hull ID number" do
        it "is not valid" do
          ...
          vessel = build(:register_vessel, hin: invalid_hin)
      ...
      describe "number of hulls" do
        it "is not present" do
          vessel = build(:register_vessel, number_of_hulls: nil)
          expect(vessel).not_to be_valid
        end

        it "is less than 1" do
          vessel = build(:register_vessel, number_of_hulls: 0)
          expect(vessel).not_to be_valid
        end

        it "is greater than 6" do
          vessel = build(:register_vessel, number_of_hulls: 7)
          expect(vessel).not_to be_valid
        end
      end
      ...
      describe "radio call sign" do
        it "is not present" do
          vessel = build(:register_vessel, radio_call_sign: nil)
          expect(vessel).not_to be_valid
        end
