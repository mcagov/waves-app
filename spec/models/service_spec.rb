...
describe "Service" do
  ...
  context "#premium_price(part)" do
    it { expect(service.premium_price(:part_1)).to eq(30400) }
    it { expect(service.premium_price(:part_2)).to be_blank }
    it { expect(service.premium_price(:part_3)).to eq(7500) }
    it { expect(service.premium_price(:part_4)).to eq(30400) }
  end
